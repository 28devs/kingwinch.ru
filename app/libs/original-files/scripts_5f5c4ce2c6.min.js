...
$(document).ready(function(){var sliders_delay=12000,wwr=$(window).width(),whr=$(window).height(),screen_height=$.mobile.getScreenHeight();$('.mobile_menu').height(screen_height);$('footer .arr, .cover_link').on('click',function(){$('footer').toggleClass('open_map');})
$('[data-open-contacts]').on('click',function(e){e.preventDefault();$('footer').addClass('open_contacts');initMap();})
$('footer .close').on('click',function(){$('footer').removeClass('open_contacts');})
$('.linktomap').on('click',function(){$('footer').addClass('open_map');})
$(".scroll").click(function(event){event.preventDefault();var dest=0;if($(this.hash).offset().top>$(document).height()-$(window).height()){dest=$(document).height()-$(window).height();}else{dest=$(this.hash).offset().top;}
$('html,body').animate({scrollTop:dest},1000,'swing');});$("[data-scroll]").click(function(event){event.preventDefault();var dest=0,hash='#'+$(this).data('scroll');if($(hash).offset().top>$(document).height()-$(window).height()){dest=$(document).height()-$(window).height();}else{dest=$(hash).offset().top;}
$('html,body').animate({scrollTop:dest},1000,'swing');if(wwr<992){$('body').removeClass('open_menu');}});$('.burger').on('click',function(){$('body').addClass('open_menu');$.scrollLock();})
$('.mobile_menu_close').on('click',function(){$('body').removeClass('open_menu');$.scrollLock();})
if(wwr>767){changeHeight();}
var firstScreenSwiper=new Swiper('.first_screen .swiper-container',{loop:true,grabCursor:false,autoplay:{delay:sliders_delay},navigation:{nextEl:'.first_screen .swiper-button-next',prevEl:'.first_screen .swiper-button-prev'},on:{slideChange:function(){$('.first_screen .b_lines b').eq(this.realIndex).addClass('active').siblings().removeClass('active');},init:function(){startStopSlider(this);}}})
var locationSwiper=new Swiper('.locations .swiper-container',{loop:true,grabCursor:true,navigation:{nextEl:'.locations .swiper-button-next',prevEl:'.locations .swiper-button-prev'},autoplay:{delay:sliders_delay},on:{slideChange:function(){$('.location_pagination li').eq(this.realIndex).addClass('active').siblings().removeClass('active');},init:function(){startStopSlider(this);}}})
$('.location_pagination li a').on('click',function(e){e.preventDefault();var indx=$(this).parent().index();locationSwiper.slideTo(indx+1);})
var homeServSwiper=new Swiper('.home_serv_slider .swiper-container',{loop:true,grabCursor:true,autoplay:{delay:sliders_delay},effect:'fade',on:{slideChange:function(){$('.slider_pages .item').eq(this.realIndex).addClass('active').siblings().removeClass('active');},init:function(){startStopSlider(this);}}})
var yearSwiper=new Swiper('.year_slider .swiper-container',{loop:true,slidesPerView:'auto',spaceBetween:100})
var historySwiper=new Swiper('.history .right_slider .swiper-container',{loop:true,grabCursor:true,autoplay:{delay:sliders_delay},navigation:{nextEl:'.history .swiper-button-next',prevEl:'.history .swiper-button-prev'},pagination:{el:'.history .pages',type:'fraction'},on:{slideChange:function(){yearSwiper.slideTo(this.realIndex);$('.history .desc .item').eq(this.realIndex).fadeIn(300).siblings().hide();$('.history .b_lines b').eq(this.realIndex).addClass('active').siblings().removeClass('active');},init:function(){startStopSlider(this);}}})
if($('.home_press').length>0){var homePressSwiper=new Swiper('.home_press .swiper-container',{loop:true,grabCursor:true,autoplay:{delay:sliders_delay},navigation:{nextEl:'.home_press .swiper-button-next',prevEl:'.home_press .swiper-button-prev'},on:{slideChange:function(){$('.home_press .info .item').eq(this.realIndex).fadeIn(300).siblings().hide();$('.home_press .b_lines b').eq(this.realIndex).addClass('active').siblings().removeClass('active');},init:function(){startStopSlider(this);}}})}
var partnershipTitleSwiper=new Swiper('.partnership .title_slider .swiper-container',{loop:false,direction:'vertical',slidesPerView:'auto',spaceBetween:10,slideToClickedSlide:true})
var partnershipSwiper=new Swiper('.partnership .right_slider .swiper-container',{loop:true,grabCursor:true,autoplay:{delay:sliders_delay},pagination:{el:'.partnership .pages',type:'fraction'},navigation:{nextEl:'.partnership .swiper-button-next',prevEl:'.partnership .swiper-button-prev'},on:{slideChange:function(){$('.partnership .title_slider .swiper-slide').eq(this.realIndex).addClass('swiper-slide-active').siblings().removeClass('swiper-slide-active');$('.partnership .desc .item').eq(this.realIndex).fadeIn(300).siblings().hide();$('.partnership .b_lines b').eq(this.realIndex).addClass('active').siblings().removeClass('active');},init:function(){startStopSlider(this);}}})
$('body').on('click','.partnership .title_slider .swiper-slide',function(){var indx=$(this).index();partnershipSwiper.slideTo(indx+1);$(this).addClass('swiper-slide-active').siblings().removeClass('swiper-slide-active');})
if($('.park_slider').length>0){var parkSwiper=new Swiper('.park_slider .swiper-container',{loop:true,grabCursor:true,navigation:{nextEl:'.park_slider .swiper-button-next',prevEl:'.park_slider .swiper-button-prev'},autoplay:{delay:sliders_delay},on:{slideChange:function(){$('.park_slider_info').eq(this.realIndex).fadeIn(300).siblings().hide();$('.park_slider .b_lines b').eq(this.realIndex).addClass('active').siblings().removeClass('active');},init:function(){startStopSlider(this);}}})}
if($('.home_news').length>0){var homeNewsSwiper=new Swiper('.home_news .swiper-container',{loop:true,grabCursor:false,slidesPerView:'auto',spaceBetween:30,navigation:{nextEl:'.home_news .swiper-button-next',prevEl:'.home_news .swiper-button-prev'}})}
if($('.all_events').length>0&&wwr>767){var homeNewsSwiper=new Swiper('.all_events .swiper-container',{loop:true,grabCursor:false,slidesPerView:2,spaceBetween:30,navigation:{nextEl:'.all_events .swiper-button-next',prevEl:'.all_events .swiper-button-prev'}})}
var homeRidersSwiper=new Swiper('.raiders_col_slider .swiper-container',{loop:true,grabCursor:true,autoplay:{delay:sliders_delay},navigation:{nextEl:'.raiders .swiper-button-next',prevEl:'.raiders .swiper-button-prev'},pagination:{el:'.raiders .pages',type:'fraction'},on:{slideChange:function(){$('.raider_info').eq(this.realIndex).fadeIn(300).siblings().hide();$('.raiders .b_lines b').eq(this.realIndex).addClass('active').siblings().removeClass('active');},init:function(){startStopSlider(this);}}})
if($('.media_bg_slider').length>0&&wwr>767){var mediaSwiper=new Swiper('.media_bg_slider',{loop:true,grabCursor:false,mousewheel:true,direction:'vertical',speed:1000,pagination:{el:'.media_bg_slider .swiper-pagination',type:'bullets',clickable:true},on:{slideChange:function(){}}});}
var media_image_swipers=[];var thumbs_swipers=[];if(wwr>767){$(".media_images_slider .swiper-container").each(function(index,element){var $this=$(this);$this.addClass("media-instance-"+index);$this.parent().find(".swiper-button-prev").addClass("btn-prev-"+index);$this.parent().find(".swiper-button-next").addClass("btn-next-"+index);media_image_swipers[index]=new Swiper(".media-instance-"+index,{grabCursor:true,loop:true,loopedSlides:4,spaceBetween:30,slidesPerView:'auto',navigation:{nextEl:".btn-next-"+index,prevEl:".btn-prev-"+index}});});}
$(document).on('click','.back_to_video',function(e){e.preventDefault();$('body').removeClass('fix_lock');$('.media_images_sliders').fadeOut();$.scrollLock(false);})
$(document).on('click','.photo_link',function(e){e.preventDefault();$('body').addClass('fix_lock');var slider_id=$(this).data('slider-id'),idx=$(this).closest('.swiper-slide').data('swiper-slide-index');if(idx===undefined)idx=0;$('.media_images_slider').hide();$('#mediaImagesSlider_'+slider_id).show();$('.media_images_sliders').fadeIn();if(wwr<768)$(".media_images_sliders .items").mCustomScrollbar();if(media_image_swipers[idx]!==undefined)media_image_swipers[idx].update();$.scrollLock(true);})
var slider_id=0;$('.event_content .textcontent p').each(function(indx,elem){var gallery_id='gallery_'+indx,cw=$('#container').width(),r=(cw-570)/2;$('.news_modal_slider .swiper-nav').css({'right':'-'+r});if($('img',this).length==1){var image_title=$('img',this).attr('alt'),image_href=$('img',this).attr('src');if(image_title!=undefined){var image_title_div='<div class="image_title">'+image_title+'</div>';}
$('img',this).wrapAll('<div class="news_modal_image"><a href="'+image_href+'" data-fancybox></a></div>').parent().parent().unwrap().append(image_title_div);}
if($('img',this).length>1){$('img',this).wrapAll('<div class="news_modal_slider clearfix" id="slider_'+slider_id+'"><div class="swiper-container news_modal_swiper"><div class="swiper-wrapper"></div></div>');$('img',this).each(function(indx,elem){var image_href=$(elem).attr('src');$(elem).wrap('<div class="swiper-slide"><a href="'+image_href+'" data-fancybox="'+gallery_id+'"></a></div>');})
$('#slider_'+slider_id).append('<div class="swiper-nav" style="right:-'+r+'px"><div class="swiper-button-prev"></div><div class="swiper-button-next"></div></div>');slider_id++;}})
var news_swipers=[];var thumbs_swipers=[];$(".news_modal_swiper").each(function(index,element){var $this=$(this);$this.addClass("news-instance-"+index).parent().unwrap();$this.parent().find(".swiper-button-prev").addClass("btn-prev-"+index);$this.parent().find(".swiper-button-next").addClass("btn-next-"+index);news_swipers[index]=new Swiper(".news-instance-"+index,{grabCursor:true,loop:true,spaceBetween:30,slidesPerView:'auto',navigation:{nextEl:".btn-next-"+index,prevEl:".btn-prev-"+index}});if($this.parent().next('p').find('em').length>0){var slider_title=$this.parent().next('p').find('em').text();$this.parent().append('<div class="slider_title">'+slider_title+'</div>');$this.parent().next('p').remove();}});$(window).on('load resize',function(){var ww=$(this).width();if(ww<992&&mediaSwiper!==undefined){mediaSwiper.destroy(false,false);}})
$('body').on('click','.media_title_slider .swiper-slide',function(){var idx=$(this).data('idx');mediaSwiper.slideTo(idx+1);})
var monthsSwiper=new Swiper('.months .swiper-container',{loop:false,slidesPerView:'auto',spaceBetween:32,slideToClickedSlide:true,on:{init:function(){var slider=this;$('.swiper-slide',slider.el).on('click',function(){var sel_indx=$(this).index(),sel_time=$(this).text();$(this).addClass('my-active').siblings().removeClass('my-active');})
$('.months .swiper-button-next').on('click',function(){var x=$('.my-active',slider.el).position().left+$('.swiper-wrapper',slider.el).position().left;$('.my-active',slider.el).next('.swiper-slide').trigger('click');slider.slideTo($('.my-active',slider.el).index());})
$('.months .swiper-button-prev').on('click',function(){var x=$('.my-active',slider.el).position().left+$('.swiper-wrapper',slider.el).position().left;$('.my-active',slider.el).prev('.swiper-slide').trigger('click');slider.slideTo($('.my-active',slider.el).index());})}}})
$(document).on('afterShow.fb',function(e,instance,slide){var timeSelectSwiper=new Swiper('.time_select .swiper-container',{loop:false,slidesPerView:'auto',spaceBetween:32,slideToClickedSlide:true,on:{init:function(){var slider=this;$('.swiper-slide',slider.el).on('click',function(){var sel_indx=$(this).data('swiper-slide-index'),sel_time=$(this).text();$(this).addClass('my-active').siblings().removeClass('my-active');$(this).closest('form').find('input[name=time]').val(sel_time);})
$(document).on('click','.time_select .swiper-button-next',function(){var x=$('.my-active',slider.el).position().left+$('.swiper-wrapper',slider.el).position().left;$('.my-active',slider.el).next('.swiper-slide').trigger('click');slider.slideTo($('.my-active',slider.el).index());})
$(document).on('click','.time_select .swiper-button-prev',function(){var x=$('.my-active',slider.el).position().left+$('.swiper-wrapper',slider.el).position().left;$('.my-active',slider.el).prev('.swiper-slide').trigger('click');slider.slideTo($('.my-active',slider.el).index());})}}})});var service_swipers=[];$(".service_item_slider .swiper-container").each(function(index,element){var $this=$(this);$this.addClass("instance-"+index).closest('.service').data('instance',index);service_swipers[index]=new Swiper(".instance-"+index,{effect:'fade',grabCursor:true,fadeEffect:{crossFade:true}});});$('.service_tabnav').on('click','.option_group:not(.active)',function(e){e.preventDefault();var slider_index=$(this).closest('.service').data('instance');$(this).addClass('active').siblings().removeClass('active').closest('.service_col').find('.service_infobox').eq($(this).index()).fadeIn(150).siblings('.service_infobox').hide();service_swipers[slider_index].slideTo($(this).index())});$('.plus_list .item').on('click',function(){$(this).toggleClass('open');$(this).find('.desc').slideToggle('fast');})
$(window).on('resize',function(){var wwr=$(window).width();if(wwr>767){changeHeight();if(homePressSwiper!=undefined)homePressSwiper.updateSize();if(parkSwiper!=undefined)parkSwiper.updateSize();}})
function changeHeight(){var avaWidth=$('.home_press .right_slider').width(),avaHeight=avaWidth*1600 / 1210,pshipWidth=$('.partnership .right_slider').width(),pshipHeight=pshipWidth*820 / 720,parkWidth=$('.park_slider .right_slider').width(),parkHeight=parkWidth*820 / 720,hisWidth=$('.history .right_slider').width(),hisHeight=hisWidth*820 / 720;$('.home_press').height(avaHeight);$('.history').height(hisHeight);$('.park_slider').height(parkHeight);$('.partnership').height(pshipHeight);}
if(!$('body').hasClass('tpl_5')){$("header").headroom({offset:300,tolerance:{up:50,down:0}});$(window).on('scroll',function(){var scrolled=$(window).scrollTop(),head_height=$('header').height();if(scrolled>head_height*1){$('header').addClass('white');}else{$('header').removeClass('white');}});}
$('.viewAllMedia').on('click',function(e){e.preventDefault();$('body').toggleClass('open_media');})
if($('#vkMembersCount').length>0){$.ajax({url:'http://api.vk.com/method/groups.getById?gid=9752764&fields=members_count',dataType:"jsonp",success:function(e){var num=e.response[0].members_count;$('#vkMembersCount').html(num.toLocaleString()+' '+getNoun(num,'подписчик','подписчика','подписчиков'));}});}
$('.share_social a').on('click',function(){window.open(this.href,"Share","width=550, height=450");return false;})})
function startStopSlider(slider){var section=$(slider.el).closest('section');slider.autoplay.stop();$(window).on('scroll load',function(){var top=$(document).scrollTop(),slider_top=section.offset().top-$(window).height()/2;if(top>slider_top){section.addClass('view');slider.autoplay.start();}else{section.removeClass('view');slider.autoplay.stop();}})}
function getNoun(number,one,two,five){let n=Math.abs(number);n%=100;if(n>=5&&n<=20){return five;}
n%=10;if(n===1){return one;}
if(n>=2&&n<=4){return two;}
return five;}
$.fancybox.defaults.share.tpl='<div class="fancybox-share">'+'<h1 class="share_title">{{SHARE}}</h1>'+'<p class="fancybox-share__links">'+'<a class="fancybox-share__button fancybox-share__button--fb" href="https://www.facebook.com/sharer/sharer.php?u={{url}}">'+'<svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><path d="m287 456v-299c0-21 6-35 35-35h38v-63c-7-1-29-3-55-3-54 0-91 33-91 94v306m143-254h-205v72h196" /></svg>'+'<span>Facebook</span>'+'</a>'+'<a class="fancybox-share__button fancybox-share__button--vk" href="https://vk.com/share.php?url={{url}}">'+'<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 548.358 548.358" xml:space="preserve"><path d="M545.451,400.298c-0.664-1.431-1.283-2.618-1.858-3.569c-9.514-17.135-27.695-38.167-54.532-63.102l-0.567-0.571   l-0.284-0.28l-0.287-0.287h-0.288c-12.18-11.611-19.893-19.418-23.123-23.415c-5.91-7.614-7.234-15.321-4.004-23.13   c2.282-5.9,10.854-18.36,25.696-37.397c7.807-10.089,13.99-18.175,18.556-24.267c32.931-43.78,47.208-71.756,42.828-83.939   l-1.701-2.847c-1.143-1.714-4.093-3.282-8.846-4.712c-4.764-1.427-10.853-1.663-18.278-0.712l-82.224,0.568   c-1.332-0.472-3.234-0.428-5.712,0.144c-2.475,0.572-3.713,0.859-3.713,0.859l-1.431,0.715l-1.136,0.859   c-0.952,0.568-1.999,1.567-3.142,2.995c-1.137,1.423-2.088,3.093-2.848,4.996c-8.952,23.031-19.13,44.444-30.553,64.238   c-7.043,11.803-13.511,22.032-19.418,30.693c-5.899,8.658-10.848,15.037-14.842,19.126c-4,4.093-7.61,7.372-10.852,9.849   c-3.237,2.478-5.708,3.525-7.419,3.142c-1.715-0.383-3.33-0.763-4.859-1.143c-2.663-1.714-4.805-4.045-6.42-6.995   c-1.622-2.95-2.714-6.663-3.285-11.136c-0.568-4.476-0.904-8.326-1-11.563c-0.089-3.233-0.048-7.806,0.145-13.706   c0.198-5.903,0.287-9.897,0.287-11.991c0-7.234,0.141-15.085,0.424-23.555c0.288-8.47,0.521-15.181,0.716-20.125   c0.194-4.949,0.284-10.185,0.284-15.705s-0.336-9.849-1-12.991c-0.656-3.138-1.663-6.184-2.99-9.137   c-1.335-2.95-3.289-5.232-5.853-6.852c-2.569-1.618-5.763-2.902-9.564-3.856c-10.089-2.283-22.936-3.518-38.547-3.71   c-35.401-0.38-58.148,1.906-68.236,6.855c-3.997,2.091-7.614,4.948-10.848,8.562c-3.427,4.189-3.905,6.475-1.431,6.851   c11.422,1.711,19.508,5.804,24.267,12.275l1.715,3.429c1.334,2.474,2.666,6.854,3.999,13.134c1.331,6.28,2.19,13.227,2.568,20.837   c0.95,13.897,0.95,25.793,0,35.689c-0.953,9.9-1.853,17.607-2.712,23.127c-0.859,5.52-2.143,9.993-3.855,13.418   c-1.715,3.426-2.856,5.52-3.428,6.28c-0.571,0.76-1.047,1.239-1.425,1.427c-2.474,0.948-5.047,1.431-7.71,1.431   c-2.667,0-5.901-1.334-9.707-4c-3.805-2.666-7.754-6.328-11.847-10.992c-4.093-4.665-8.709-11.184-13.85-19.558   c-5.137-8.374-10.467-18.271-15.987-29.691l-4.567-8.282c-2.855-5.328-6.755-13.086-11.704-23.267   c-4.952-10.185-9.329-20.037-13.134-29.554c-1.521-3.997-3.806-7.04-6.851-9.134l-1.429-0.859c-0.95-0.76-2.475-1.567-4.567-2.427   c-2.095-0.859-4.281-1.475-6.567-1.854l-78.229,0.568c-7.994,0-13.418,1.811-16.274,5.428l-1.143,1.711   C0.288,140.146,0,141.668,0,143.763c0,2.094,0.571,4.664,1.714,7.707c11.42,26.84,23.839,52.725,37.257,77.659   c13.418,24.934,25.078,45.019,34.973,60.237c9.897,15.229,19.985,29.602,30.264,43.112c10.279,13.515,17.083,22.176,20.412,25.981   c3.333,3.812,5.951,6.662,7.854,8.565l7.139,6.851c4.568,4.569,11.276,10.041,20.127,16.416   c8.853,6.379,18.654,12.659,29.408,18.85c10.756,6.181,23.269,11.225,37.546,15.126c14.275,3.905,28.169,5.472,41.684,4.716h32.834   c6.659-0.575,11.704-2.669,15.133-6.283l1.136-1.431c0.764-1.136,1.479-2.901,2.139-5.276c0.668-2.379,1-5,1-7.851   c-0.195-8.183,0.428-15.558,1.852-22.124c1.423-6.564,3.045-11.513,4.859-14.846c1.813-3.33,3.859-6.14,6.136-8.418   c2.282-2.283,3.908-3.666,4.862-4.142c0.948-0.479,1.705-0.804,2.276-0.999c4.568-1.522,9.944-0.048,16.136,4.429   c6.187,4.473,11.99,9.996,17.418,16.56c5.425,6.57,11.943,13.941,19.555,22.124c7.617,8.186,14.277,14.271,19.985,18.274   l5.708,3.426c3.812,2.286,8.761,4.38,14.853,6.283c6.081,1.902,11.409,2.378,15.984,1.427l73.087-1.14   c7.229,0,12.854-1.197,16.844-3.572c3.998-2.379,6.373-5,7.139-7.851c0.764-2.854,0.805-6.092,0.145-9.712   C546.782,404.25,546.115,401.725,545.451,400.298z" fill="#FFFFFF"/></svg>'+'<span>Вконтакте</span>'+'</a>'+'<a class="fancybox-share__button fancybox-share__button--tw" href="https://twitter.com/intent/tweet?url={{url}}&text={{descr}}">'+'<svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><path d="m456 133c-14 7-31 11-47 13 17-10 30-27 37-46-15 10-34 16-52 20-61-62-157-7-141 75-68-3-129-35-169-85-22 37-11 86 26 109-13 0-26-4-37-9 0 39 28 72 65 80-12 3-25 4-37 2 10 33 41 57 77 57-42 30-77 38-122 34 170 111 378-32 359-208 16-11 30-25 41-42z" /></svg>'+'<span>Twitter</span>'+'</a>'+'</p>'+'<p><input class="fancybox-share__input" type="text" value="{{url_raw}}" /></p>'+'</div>';$.scrollLock=(function scrollLockClosure(){'use strict';var $html=$('html'),locked=false,prevScroll={scrollLeft:$(window).scrollLeft(),scrollTop:$(window).scrollTop()},prevStyles={},lockStyles={'overflow-y':'scroll','position':'fixed','width':'100%'};saveStyles();function saveStyles(){var styleAttr=$html.attr('style'),styleStrs=[],styleHash={};if(!styleAttr){return;}
